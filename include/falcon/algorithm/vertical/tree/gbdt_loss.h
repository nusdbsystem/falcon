...
class LossFunction {
 ...
 public:
   ...
   * @param residual: the returned encrypted residual
   ...
   * @param party: the participating party
   * @param decision_tree_builder: the tree builder, which includes the dataset
   *    and labels, as well as the encrypted sample mask on each leave, etc.
   * @param residual: the encrypted residual for this tree
   * @param raw_predictions: the encrypted raw_predictions for this tree
   * @param size: the size of the predicting samples
   * @param learning_rate: the shrinkage rate in the gbdt params
