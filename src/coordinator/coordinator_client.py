...
'''
python coordinator_client.py -url 172.25.123.254:30004 -method submit -path /Users/nailixing/GOProj/src/github.com/falcon/src/coordinator/data/dslTest.json
