...
'''
python falcon_flow_client.py -url 172.25.122.185:6573 -method submit -path /Users/nailixing/GOProj/src/github.com/falcon/src/coordinator/data/dsl.json
python falcon_flow_client.py -url 172.25.122.185:6573 -method kill -job 60
python falcon_flow_client.py -url 172.25.122.185:6573 -method query_status -job 60
'''
