...
static void InitDefaultsscc_info_LogisticRegressionParams_lr_5fparams_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_LogisticRegressionParams_lr_5fparams_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_LogisticRegressionParams_lr_5fparams_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_lr_5fparams_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_lr_5fparams_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_lr_5fparams_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_lr_5fparams_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_lr_5fparams_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "acy_budget\030\014 \001(\002B\010Z\006commonb\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_lr_5fparams_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_lr_5fparams_2eproto_sccs[1] = {
  &scc_info_LogisticRegressionParams_lr_5fparams_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_lr_5fparams_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_lr_5fparams_2eproto = {
  false, false, descriptor_table_protodef_lr_5fparams_2eproto, "lr_params.proto", 354,
  &descriptor_table_lr_5fparams_2eproto_once, descriptor_table_lr_5fparams_2eproto_sccs, descriptor_table_lr_5fparams_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_lr_5fparams_2eproto::offsets,
  file_level_metadata_lr_5fparams_2eproto, 1, file_level_enum_descriptors_lr_5fparams_2eproto, file_level_service_descriptors_lr_5fparams_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_lr_5fparams_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_lr_5fparams_2eproto)), true);
namespace com {
namespace nus {
namespace dbsytem {
namespace falcon {
...
void LogisticRegressionParams::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_LogisticRegressionParams_lr_5fparams_2eproto.base);
  penalty_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  optimizer_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  multi_class_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  metric_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
