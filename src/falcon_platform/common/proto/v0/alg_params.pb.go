...
type MlpParams struct {
	...
	IsClassification bool `protobuf:"varint,1,opt,name=is_classification,json=isClassification,proto3" json:"is_classification,omitempty"`
	...
	// maximum number of iterations for training
	MaxIteration int32 `protobuf:"varint,3,opt,name=max_iteration,json=maxIteration,proto3" json:"max_iteration,omitempty"`
	// tolerance of convergence
	ConvergeThreshold float64 `protobuf:"fixed64,4,opt,name=converge_threshold,json=convergeThreshold,proto3" json:"converge_threshold,omitempty"`
	// whether use regularization or not
	WithRegularization bool `protobuf:"varint,5,opt,name=with_regularization,json=withRegularization,proto3" json:"with_regularization,omitempty"`
	// regularization parameter
	...
	// t is #iteration
	Decay float64 `protobuf:"fixed64,8,opt,name=decay,proto3" json:"decay,omitempty"`
	// penalty method used, 'l1' or 'l2', default l2, currently support 'l2'
	Penalty string `protobuf:"bytes,9,opt,name=penalty,proto3" json:"penalty,omitempty"`
	// optimization method, default 'sgd', currently support 'sgd'
	Optimizer string `protobuf:"bytes,10,opt,name=optimizer,proto3" json:"optimizer,omitempty"`
	// evaluation metric for training and testing, 'mse'
	Metric string `protobuf:"bytes,11,opt,name=metric,proto3" json:"metric,omitempty"`
	// differential privacy (DP) budget, 0 denotes not use DP
	DpBudget float64 `protobuf:"fixed64,12,opt,name=dp_budget,json=dpBudget,proto3" json:"dp_budget,omitempty"`
	...
	NumLayersOutputs []int32 `protobuf:"varint,14,rep,packed,name=num_layers_outputs,json=numLayersOutputs,proto3" json:"num_layers_outputs,omitempty"`
	// the vector of layers activation functions
	LayersActivationFuncs []string `protobuf:"bytes,15,rep,name=layers_activation_funcs,json=layersActivationFuncs,proto3" json:"layers_activation_funcs,omitempty"`
}

func (x *MlpParams) Reset() {
	*x = MlpParams{}
	if protoimpl.UnsafeEnabled {
		mi := &file_alg_params_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *MlpParams) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MlpParams) ProtoMessage() {}

func (x *MlpParams) ProtoReflect() protoreflect.Message {
	mi := &file_alg_params_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MlpParams.ProtoReflect.Descriptor instead.
func (*MlpParams) Descriptor() ([]byte, []int) {
	return file_alg_params_proto_rawDescGZIP(), []int{5}
}

func (x *MlpParams) GetIsClassification() bool {
	if x != nil {
		return x.IsClassification
	}
	return false
}

func (x *MlpParams) GetBatchSize() int32 {
	if x != nil {
		return x.BatchSize
	}
	return 0
...
func (x *MlpParams) GetMaxIteration() int32 {
	if x != nil {
		return x.MaxIteration
	}
	return 0
...
func (x *MlpParams) GetConvergeThreshold() float64 {
	if x != nil {
		return x.ConvergeThreshold
	}
	return 0
...
func (x *MlpParams) GetWithRegularization() bool {
	if x != nil {
		return x.WithRegularization
	}
	return false
...
func (x *MlpParams) GetAlpha() float64 {
	if x != nil {
		return x.Alpha
	}
	return 0
...
func (x *MlpParams) GetLearningRate() float64 {
	if x != nil {
		return x.LearningRate
	}
	return 0
...
func (x *MlpParams) GetDecay() float64 {
	if x != nil {
		return x.Decay
	}
	return 0
...
func (x *MlpParams) GetPenalty() string {
	if x != nil {
		return x.Penalty
	}
	return ""
...
func (x *MlpParams) GetOptimizer() string {
	if x != nil {
		return x.Optimizer
	}
	return ""
...
func (x *MlpParams) GetMetric() string {
	if x != nil {
		return x.Metric
	}
	return ""
...
func (x *MlpParams) GetDpBudget() float64 {
	if x != nil {
		return x.DpBudget
	}
	return 0
...
func (x *MlpParams) GetFitBias() bool {
	if x != nil {
		return x.FitBias
	}
	return false
...
func (x *MlpParams) GetNumLayersOutputs() []int32 {
	if x != nil {
		return x.NumLayersOutputs
	}
	return nil
}

func (x *MlpParams) GetLayersActivationFuncs() []string {
	if x != nil {
		return x.LayersActivationFuncs
	}
	return nil
}
...
var file_alg_params_proto_rawDesc = []byte{
	...
	,
}
...
var file_alg_params_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_alg_params_proto_goTypes = []interface{}{
	...
	(*MlpParams)(nil),                // 5: com.nus.dbsytem.falcon.v0.MlpParams
}
...
func file_alg_params_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_alg_params_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MlpParams); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
