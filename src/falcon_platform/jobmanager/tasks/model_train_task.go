...
func init() {
	...
	allTasks[common.ModelTrainTaskKey] = new(ModelTrainTask)
}
...
func (this *ModelTrainTask) GetCommand(taskInfo *entity.TaskContext) (*exec.Cmd, error) {
	...
	modelInputFile := common.TaskDataPath + "/" + job.Tasks.ModelTraining.InputConfigs.DataInput.Data
	modelFile := common.TaskModelPath + "/" + job.Tasks.ModelTraining.OutputConfigs.TrainedModel
	logFile := common.TaskRuntimeLogs + "-" + job.Tasks.ModelTraining.AlgorithmName
	KeyFile := common.TaskDataPath + "/" + job.Tasks.ModelTraining.InputConfigs.DataInput.Key
	modelReportFile := common.TaskModelPath + "/" + job.Tasks.ModelTraining.OutputConfigs.EvaluationReport
	...
	cmd := exec.Command(
		...
		"--key-file", KeyFile,
		"--algorithm-name", job.Tasks.ModelTraining.AlgorithmName,
		"--algorithm-params", job.Tasks.ModelTraining.InputConfigs.SerializedAlgorithmConfig,
