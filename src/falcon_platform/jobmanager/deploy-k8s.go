...
func DeployMasterK8s(dslOjb *cache.DslObj, workerType string) {
...
func DeployWorkerK8s(masterAddr, workerType, jobId, dataPath, modelPath, dataOutput string,
	workerID common.WorkerIdType, distributedRole uint) {
	...
	command := []string{
		...
		fmt.Sprintf("%d", distributedRole), // 13. distributedRole
	}
