...
func (this *LimeInterpretTask) GetCommand() *exec.Cmd {
	...
	modelInputFile := common.TaskDataPath + "/" + this.DslObj.Tasks.LimeInterpret.InputConfigs.DataInput.Data
	modelFile := common.TaskModelPath + "/" + this.DslObj.Tasks.LimeInterpret.OutputConfigs.TrainedModel
	logFile := common.TaskRuntimeLogs + "-" + this.DslObj.Tasks.LimeInterpret.AlgorithmName
	KeyFile := common.TaskDataPath + "/" + this.DslObj.Tasks.LimeInterpret.InputConfigs.DataInput.Key
	modelReportFile := common.TaskModelPath + "/" + this.DslObj.Tasks.LimeInterpret.OutputConfigs.EvaluationReport
	...
	cmd := exec.Command(
		...
		"--key-file", KeyFile,
		"--algorithm-name", this.DslObj.Tasks.LimeInterpret.AlgorithmName,
		"--algorithm-params", this.DslObj.Tasks.LimeInterpret.InputConfigs.SerializedAlgorithmConfig,
