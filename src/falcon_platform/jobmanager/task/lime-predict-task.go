...
func (this *LimePredictTask) GetCommand() *exec.Cmd {
	...
	modelInputFile := common.TaskDataPath + "/" + this.DslObj.Tasks.LimePred.InputConfigs.DataInput.Data
	modelFile := common.TaskModelPath + "/" + this.DslObj.Tasks.LimePred.OutputConfigs.TrainedModel
	logFile := common.TaskRuntimeLogs + "-" + this.DslObj.Tasks.LimePred.AlgorithmName
	KeyFile := common.TaskDataPath + "/" + this.DslObj.Tasks.LimePred.InputConfigs.DataInput.Key
	modelReportFile := common.TaskModelPath + "/" + this.DslObj.Tasks.LimePred.OutputConfigs.EvaluationReport
	...
	cmd := exec.Command(
		...
		"--key-file", KeyFile,
		"--algorithm-name", this.DslObj.Tasks.LimePred.AlgorithmName,
		"--algorithm-params", this.DslObj.Tasks.LimePred.InputConfigs.SerializedAlgorithmConfig,
